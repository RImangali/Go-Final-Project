...
func createUser(client pb.UserServiceClient) {
    req := &pb.CreateUserRequest{Name: "Rakhatuly Imangali", Email: "210107008@stu.sdu.edu.kz", Password: "Imangali2004"}
...
func updateUser(client pb.UserServiceClient) {
    req := &pb.UpdateUserRequest{Id: "1", Name: "Rakhmetolla Assar", Email: "210107159@stu.sdu.edu.kz"}
